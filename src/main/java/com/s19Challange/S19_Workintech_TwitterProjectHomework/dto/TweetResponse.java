...
public record TweetResponse(Long tweetId, String tweetText, String tweetImageUrl, Long userId, String userFirstName, String userLastName, String userName,
                            List<LikesTweetResponse> likes, List<TweetCommentResponse> comments, List<TweetRetweetResponse> retweets, Long commentCount, Long likeCount, Long retweetCount) {
}
